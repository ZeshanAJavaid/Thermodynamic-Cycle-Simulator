...
"color: rgb(255,255,255);"));
        ...
        QWidget::setTabOrder(Temperature_Input, Pressure_Input);
        QWidget::setTabOrder(Pressure_Input, Compression_Ratio_Input);
        QWidget::setTabOrder(Compression_Ratio_Input, Compression_eff_input);
        QWidget::setTabOrder(Compression_eff_input, Expansion_eff_input);
        QWidget::setTabOrder(Expansion_eff_input, Help_Button);
        QWidget::setTabOrder(Help_Button, Back_Button);
        QWidget::setTabOrder(Back_Button, Begin_Button);
