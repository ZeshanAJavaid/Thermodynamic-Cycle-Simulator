...
""));
        ...
        QWidget::setTabOrder(initial_temperature_input, Initial_pressure_input);
        QWidget::setTabOrder(Initial_pressure_input, Ratio_Input);
        QWidget::setTabOrder(Ratio_Input, Compression_eff_input);
