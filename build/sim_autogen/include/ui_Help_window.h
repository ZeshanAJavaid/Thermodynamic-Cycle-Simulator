...
public:
    ...
    void setupUi(QMainWindow *HelpWindow)
    {
        ...
        HelpWindow->setMaximumSize(QSize(602, 402));
...
""));
        ...
        Title_Label->setGeometry(QRect(10, 10, 601, 51));
        QFont font;
        ...
        Close_Button->setGeometry(QRect(260, 330, 141, 51));
        QFont font1;
